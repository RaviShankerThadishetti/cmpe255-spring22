...
class CarPrice:
    ...
    def __init__(self):
        self.df = pd.read_csv(
            r'C:\Users\Ravi Shanker\Desktop\cmpe255-spring21-main\lab2\data\data.csv')
...
def calculate() -> None:
    ...
    print("For test data set, the RMSE value of Original msrp and predicted msrp is: ",
